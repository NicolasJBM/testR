#' @name export_test_to_docx
#' @title Export test to DOCX files
...
#' @param template_folder Character. Path to the md folder.
...
export_test_to_docx <- function(
  ...
  questions_template <- base::paste0(
    template_folder, "/", template, "_questions_", language, ".md"
  )
  
  solutions_template <- base::paste0(
    template_folder, "/", template, "_solutions_", language, ".md"
  )
