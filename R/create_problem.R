...
#' @description Function creating a problem question and retrieving correct answers from the propositions table.
...
create_problem <- function(propositions, codes, interrogation){
